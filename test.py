...
def build_stock_features(data: List[object]):
    ...
    for item in data:
        ...
        print(end_date, symbol)
        df = get_price_volume_binance(end_date, symbol, "1d", 100)
...
# Example
# df = get_price_volume_binance("BTCUSDT", "1d", 30)
# print(df)

result = build_stock_features([{"date": "20231001", "symbol": "AAVEUSDT"}])
